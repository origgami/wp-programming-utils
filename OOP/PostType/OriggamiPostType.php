...
class OriggamiPostType {
	...
	function getLabels() {
		...
		$labelsDefaults=array(
			...
			'add_new'			 => _x('Adicionar '.$nameInfs['singular'], $nameInfs['singular'], $this->getTextDomain()),
			'add_new_item'		 => __('Adicionar '.$nameInfs['singular'].'', $this->getTextDomain()),
			'new_item'			 => __('Nova '.$nameInfs['singular'].'', $this->getTextDomain()),
			'edit_item'			 => __('Editar '.$nameInfs['singular'].'', $this->getTextDomain()),
			'view_item'			 => __('Ver '.$nameInfs['singular'].'', $this->getTextDomain()),
			'all_items'			 => __($nameInfs['plural'], $this->getTextDomain()),
			'search_items'		 => __('Buscar '.$nameInfs['plural'].'', $this->getTextDomain()),
			'parent_item_colon'	 => __(''.$nameInfs['plural'].' pai:', $this->getTextDomain()),
			'not_found'			 => __('Nada encontrado.', $this->getTextDomain()),
			'not_found_in_trash' => __('Nada encontrado na lixeira.', $this->getTextDomain())
		);
